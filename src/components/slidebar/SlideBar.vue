    ...
    <el-row class="container">
      <el-col :span="16" class="left" @click="toggleSlideBar">
        ...
        <el-menu class="el-menu-vertical-demo" @select="handleSelect">
          ...
          <el-menu-item index="2"><i class="icon-eye"></i><div class="navtext">收藏</div></el-menu-item>
          <el-menu-item index="3"><i class="icon-bubbles3"></i><div class="navtext">信息</div></el-menu-item>
